...
NODE_ENV=production node node_modules/.bin/webpack --config ./webpack/iframeMadness/webpack.config.prod.d.js --color -p --progress
echo Building Replay Test
NODE_ENV=production node node_modules/.bin/webpack --config ./webpack/replayTest/webpack.config.prod.d.js --color -p --progress
...
NODE_ENV=production node node_modules/.bin/webpack --config ./webpack/reactSpa/webpack.config.prod.d.js --color -p --progress
